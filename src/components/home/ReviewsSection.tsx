  ...
  const reviews = [
    {
      ...
      content: "Paradise Tours exceeded all expectations! The Swiss Alps tour was perfectly organized, and our guide was incredibly knowledgeable. Every detail was taken care of, from luxury accommodations to authentic local experiences.",
    ...
    },
    {
      ...
      content: "The Ancient Temples tour in Cambodia was enlightening and beautifully organized. Our local guide shared fascinating stories, and we felt deeply connected to the culture and history of the region.",
      trip: "Ancient Temples Tour",
      date: "January 2025",
      verified: true
    },
    {
      ...
      content: "Our honeymoon trip to Maldives was absolutely perfect. The overwater villa, private dinners on the beach, and snorkeling experiences were all exceptional. Thank you for making our special time so memorable!",
